...
Promise.all([ytbTest(),disneyLocation(),nfTest(),daznTest(),parmTest(),discoveryTest(),gptTest(),googleToCN()]).then(value => {
    let content = "------------------------------------</br>"+([result["YouTube"],result["Netflix"],result["Disney"],result["Dazn"],result["Discovery"],result["Paramount"],result["ChatGPT"],result["googleToCN"]]).join("</br></br>")
